...
और PostgreSQL C में लिखे हैं, इसलिए "memory-safe" उन हिस्सों का वर्णन करता है जो हमने चुने, पूरे स्टैक का नहीं।
...
| निष्क्रिय RAM (मापा गया) | **218–288 MiB** | mailcow: 6 GiB min (docs) | — | — |
